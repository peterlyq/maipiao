                ...
                <li class="film-list-item" v-for="item in dataList" :key="item.filmId">
                    <router-link :to="{name:'filmDetail',params:{id:item.filmId}}">
                        ...
                        <div class="film-list-item-desc">
                            <h3 class="item-desc-name"><span class="name">{{item.name}}</span><span class="is-3d">3D</span></h3>
                            <p class="item-desc-grade info-col"><span >观众评分 </span><span class="grade">{{item.grade}}</span></p>
                            <p class="item-desc-actors info-col"><label>主演：</label><span>{{item.actors | filterActors}}</span></p>
                            <p class="item-desc-times info-col"><label>{{item.nation}}</label> | <span>{{item.runtime}}分钟</span></p>
                        </div>
                        <div class="film-list-item-action padding"><span href="" class="buy">购买</span></div>
                    </router-link>
                </li>
